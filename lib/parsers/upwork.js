...
export async function parseUpwork() {
  ...
  const KEYWORD_GROUPS = [
    ...
    ['graphic design', 'logo design', 'UI UX design', 'web design', 'figma'],
    ['wordpress', 'html css', 'react', 'javascript', 'frontend developer'],
    /*   ['python', 'node.js', 'PHP', 'backend developer', 'full stack'], */
  ];
